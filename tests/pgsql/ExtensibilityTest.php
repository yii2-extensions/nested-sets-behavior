...
/**
 * Test suite for extensibility in nested sets tree behaviors using PostgreSQL.
 *
 * Verifies that protected methods in the nested sets behavior remain accessible and customizable for subclassing
 * scenarios on PostgreSQL, ensuring extensibility for advanced use cases in both single-tree and multi-tree models.
 *
