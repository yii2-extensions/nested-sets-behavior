...
/**
 * Test suite for node state and relationship in nested sets tree behaviors using PostgreSQL.
 *
 * Provides comprehensive unit tests for verifying node state, parent-child relationships, and root/leaf detection in
 * both single-tree and multi-tree nested sets models on PostgreSQL.
 *
